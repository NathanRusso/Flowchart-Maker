...
6. **Show Transfer** - A button that show the transfer section.
7. **Hide Transfer** - A button that hides the transfer section, saving all data inside of it.
8. **Clear Flowchart** - A button the deletes the current flowchart and reverts the website back to default.
